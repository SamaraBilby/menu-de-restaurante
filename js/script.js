const menu = [
    ...
    descricao: 'Iscas de peito de frango, alface, tomate, 1 fatia de queijo muçarela e maionese americana',
},
{
    id: 2,
    ...
    descricao: '100 g do hamburger 100% carne Angus, 2 fatias de muçarela derretida, alface, tomate fresquinho, picles, cebola e maionese à sua escolha.'
},
{
    id: 3,
...
},
{
    ...
    descricao: '150 g do hamburger 100% carne Angus, 2 fatias de muçarela derretida, alface, tomate fresquinho, picles, cebola e maionese à sua escolha.',
},
{
    id: 6,
...
},
{
    ...
    descricao: 'preparada com alface romana e molho Caesar. Os temperos usados para compor este molho são azeite de oliva, suco de limão, anchovas, queijo parmesão, molho inglês, sal, açúcar e pimenta preta. A salada geralmente é servida com croutons e queijo parmesão fresco ralado.',
},
{
    id: 9,
    ...
    descricao: 'Cubos de peito de frango, tomates cereja, alface, pepino e molho a escolha',
},
{
    id: 10,
    ...
    preco: 25.00,
    imagem: '../assets/image/salada/salada-frango-melancia.jpg',
    descricao: 'tomatinho cereja, alho, pão brioche, manjericão, alface americana e mini pão baguete',
},
{
    id: 11,
    title: 'Salada Verão',
    ...
    descricao: 'Iscas de frango, tomate cereja, manga, manjericão e molho de laranja ou de preferência',
},
{
    id: 12,
    ...
    descricao: 'Iscas de frango, tomate cereja, brocolis, cenoura cozida, manjericão e molho da preferência',
},
{
    id: 13,
    ...
    descricao: '2 unidades de Sorvete de baunilha com pedaços de chocolate ou chocolate crocante',
},
{
    id: 14,
    ...
    descricao: '2 sanduiche de 50g hamburger 100% carne Angus, 2 fatias de muçarela derretida, alface, tomate fresquinho, picles e maionese americana',
},
{
    id: 15,
    ...
    categoria: 'promocao',
    preco: 25.00,
    imagem: '../assets/image/promocao/frita-assa-de-frango-batata-calabresa-carne.jpg',
    descricao: 'Coxas de frango frito, batata-frita ou assada, fatias de cenoura, calabresa na chapa, isca de carne e molho de preferência',
},
{
    id: 16,
    ...
    categoria: 'promocao',
    preco: 25.00,
    imagem: '../assets/image/promocao/promocao-anais-cebola-camarao-asa-frango.jpg',
    descricao: 'Coxas de frango frito, batata-frita ou assada, fatias de cenoura, calabresa na chapa, camarão frito, aneis da cebola e molho de preferência',
},
{
    id: 17,
